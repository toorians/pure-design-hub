...
export default function AboutUsComp() {
  return (
    <>
      <section className="about_sec relative 2xl:px-55 xl:px-40 lg:px-20 px-4">
        <div className="flex lg:flex-row flex-col items-center lg:gap-10 gap-4 relative mb-14">
          <div className="group md:w-[430px] w-50 md:h-[548px] h-70 shrink-0 relative z-1 transition-all duration-500">
            <Image
              src={AboutImg1}
              title="Who We Are"
              alt="Who We Are"
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link
              href="/about-us"
              className="globalBtn text-white bg-black w-fit transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              Learn more
            </Link>
          </div>
        ...
        <div className="flex lg:flex-row flex-col items-center md:gap-10 gap-5 relative">
          ...
          <div className="group md:w-[430px] w-50 md:h-[548px] h-70 shrink-0 relative z-1 lg:order-1 order-0 transition-all duration-500">
            <Image
              src={AboutImg2}
              title="Who We Are"
              alt="Who We Are"
