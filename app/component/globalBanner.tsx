...
export default function GlobalBanner({ title, text, imagePath }: GlobalBannerProps) {
  return (
    <>
       <div className='global_baner grid lg:grid-cols-2 grid-cols-1 items-center xl:gap-10 lg:gap-5 gap-4 xl:px-30 lg:py-20 py-10 px-4'>
             <div className='lg:order-0 order-1 lg:text-left text-center'>
              ...
              <Link href='' className='globalBtn bg-[#F75126] text-white inline-flex'>Lets get Started</Link>
             </div>
