...
for Our ClientseDesignHub_hub relative overflow-hidden h-full w-full xl:mb-40 lg:mb-20 mb-10 xl:px-30 px-4"
      ...
      <section className="services_sec relative 2xl:px-40 xl:px-20 px-4 xl:mb-40 lg:mb-20 mb-10 overflow-hidden">
        ...
        <p className="text lg:my-12.5 md:my-8 my-4 text-center">
          ...
          website content writing services worldwide.
          <br className="xl:block hide"></br> We are presenting an innovative
          and eye-catching website content from highly qualified and expert
          writers. Web<br className="xl:block hide"></br> content writing is
          available through a CLICK!!
        </p>
          ...
          >
            ...
            <p
              className="text-[#FFFFFF] group-hover:text-[#050505] 
                transition-colors duration-300 ease-in-out "
            >
              Our team of content writers is proficient in the angle used in
          ...
          >
            ...
            <p
              className="text-[#FFFFFF] group-hover:text-[#050505] 
                transition-colors duration-300 ease-in-out "
            >
              With our team of adroit content writers, the deliverance is given
              in hand before time
            </p>
          </div>
          ...
          >
            ...
            <p
              className="text-[#FFFFFF] group-hover:text-[#050505] 
                transition-colors duration-300 ease-in-out "
            >
              Our talented staff and professional writers are there to answer
              your queries 24/7
            </p>
          </div>
        </div>
      ...
      <section className="services_sec relative 2xl:px-40 xl:px-20 px-4 md:py-10 my-6 mb-10 overflow-hidden bg-[#F8F8F8]">
        <h2 className="title2 text-center ">
          Get High Quality <span>Social media <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 500 150"
              preserveAspectRatio="none"
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full"
