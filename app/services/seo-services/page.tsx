...
const faqs = [
  {
    q: "Are seo services worth it in 2026?",
    a: "Yes, SEO is worth it in 2026 as they help businesses increase organic visibility, attract qualified traffic, and generate long-term leads. With a strategic approach, SEO continues to outperform paid advertising for sustainable growth.",
  },
  {
    q: "Is SEO for small business worth it for businesses in the USA?",
    a: "Yes, businesses in the USA can benefit greatly, especially with affordable SEO services for small business that improve local visibility and attract the right audience. It provides steady traffic and leads without depending only on paid marketing.",
  },
  {
    q: "Can SEO help my local business grow?",
    a: "Yes, SEO improves your visibility in local searches and Google Maps, helping you reach nearby customers who are ready to take action.",
  },
  {
    q: "How much do SEO services cost?",
    a: "The cost varies based on your goals and competition, but there are flexible options, including affordable SEO services for small businesses.",
  },
  {
    q: "How long does SEO take to show results?",
    a: "SEO usually takes 3 to 6 months to show noticeable improvements, depending on your competition and current website condition.",
  },
];
...
export default function SEOServicesNew() {
  ...
  const seoServices = [
    {
      ...
      desc: (
        <>
          Every successful SEO campaign starts with a tailored strategy. We
          analyze your business, audience, competitors, and goals to build an
          effective plan. We also assess your website's foundation, making our{" "}
          <a href="/services/web-development" className="text-[#2C9F00]">
    ...
    {
      title: "Content Optimization and Strategy",
    ...
    },
    {
      ...
      desc: "If your business targets customers in specific cities or service areas, local SEO is essential. This help business in the USA improve local visibility through location-focused optimization, Google Business Profile support, and local landing pages.",
      Icon: IcLocal,
    },
    {
  ...
  const strategySteps = [
    {
      number: "01",
      title: "Discovery and Website Review",
      desc: "We start by reviewing your website, current performance, competitors, and goals. This helps us understand where your business stands and what improvements are needed first.",
    },
    {
      number: "02",
      title: "Research and Opportunity Mapping",
      desc: "Next, we identify the most valuable keyword opportunities, service gaps, content needs, and technical issues. This creates the direction for the SEO campaign.",
    },
    {
      number: "03",
      title: "Optimization and Implementation",
      desc: "We then apply the necessary improvements across your website. This may include on-page updates, technical fixes, content enhancements, and location-focused optimization depending on your needs.",
    },
    {
      number: "04",
      title: "Growth and Refinement",
      desc: "SEO is not a one-time task. Search behavior changes, competition changes, and websites need continuous refinement. Our SEO service include ongoing review and improvement so your site can stay competitive in the USA market.",
    },
  ];

  const whyChooseUs = [
    {
      title: "Customize SEO Strategies",
      text: "Every plan is tailored to your niche, competition, and business goals in the USA.",
      Icon: IcCustomize,
    },
    {
      title: "Clean and Clear Communication",
      text: "Transparent reporting and feedback so you always know your project status.",
      Icon: IcComms,
    },
    {
      title: "Ethical Optimization Methods",
      text: "We strictly follow white-hat SEO techniques to ensure long-term site safety.",
      Icon: IcEthical,
    },
    {
      title: "Strong Content Quality",
      text: "Focusing on content that is useful, clear, original, and aligned with user intent.",
      Icon: IcQuality,
    },
    {
      title: "Technical Accuracy",
      text: "Precision audits to identify and fix every technical barrier to search performance.",
      Icon: IcAccuracy,
    },
    {
      title: "Long-term Business Growth",
      text: "We focus on building authority that keeps you profitable for years to come.",
      Icon: IcGrowth,
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-6 md:space-y-8">
              ...
              <p className="hero-line-3 text-gray-300 text-lg sm:text-xl md:text-2xl mb-8 md:mb-12 max-w-xl leading-relaxed font-light">
                Increase your site&apos;s authority and rankings with a{" "}
                ...
                <div className="bg-[#111111] border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl backdrop-blur-sm">
                  <div className="mb-8">
                    ...
                    <h2 className="text-3xl font-black text-white">
                      Book a Free{" "}
                      <span className="text-[#39b54a]">Web Audit</span>
                    </h2>
                  </div>
                  <form
                  ...
                  {successMsg && (
                    <div className="mt-6 p-4 bg-green-500/10 border border-green-500/20 rounded-lg text-[#39b54a] text-xs font-bold text-center">
                      {successMsg}
                    </div>
                  )}
                  {errorMsg && (
                    <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 text-xs font-bold text-center">
                      {errorMsg}
                    </div>
                  )}
                </div>
        ...
        <div className="relative z-10 max-w-4xl">
          ...
          <div className="space-y-6 md:space-y-8 leading-relaxed text-base sm:text-lg md:text-xl relative z-20">
            <p className="max-w-3xl text-neutral-300">
              As a trusted <a className="text-[#2C9F00]" href="/">digital marketing agency in USA</a>, Pure Design
              Hub helps businesses turn organic traffic into measurable growth.
            </p>
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 py-4 md:py-6">
              <div className="border-l-4 border-[color:var(--brand-primary)] pl-5 sm:pl-6 bg-white/[0.04] backdrop-blur-sm p-4 rounded-r-2xl shadow-sm border-white/10">
                <h4 className="font-bold text-white mb-2 uppercase tracking-tight text-sm sm:text-base">
                  Sustainable Growth
                </h4>
                <p className="text-sm sm:text-base text-neutral-400">
                  Long-term authority rather than short-term tricks.
                </p>
              </div>
              <div className="border-l-4 border-[color:var(--brand-primary)] pl-5 sm:pl-6 bg-white/[0.04] backdrop-blur-sm p-4 rounded-r-2xl shadow-sm border-white/10">
                <h4 className="font-bold text-white mb-2 uppercase tracking-tight text-sm sm:text-base">
                ...
                <p className="text-sm sm:text-base text-neutral-400">
                  Tailored to your niche, competition, and goals in the USA.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="reveal-left">
            ...
            <p className="text text-neutral-400 mb-4 md:mb-6 text-base sm:text-lg">
              The online market in the USA is highly competitive. People search
              every day for products and services, and most click businesses on
              the first page of Google.
            </p>
            <p className="text text-neutral-300 mb-4 md:mb-6 font-semibold text-base sm:text-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
              {[
                ...
                "Create long-term digital growth",
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 text-sm sm:text-base text-neutral-300 reveal-up"
                ...
                >
                  <span className="w-5 h-5 rounded-full bg-[color-mix(in_srgb,var(--brand-primary)_18%,transparent)] flex items-center justify-center flex-shrink-0">
                    <svg
                      className="w-3 h-3 text-[color:var(--brand-primary)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={3}
            ...
            <p className="text text-neutral-400 mt-6 text-base sm:text-lg">
              Professional SEO helps you attract users who are already searching
              for what you offer.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 px-4 sm:px-8 md:px-12 lg:px-20 overflow-hidden bg-white">
        <div className="max-w-[1400px] mx-auto text-center mb-10 md:mb-16 reveal-up">
          ...
          <p className="text max-w-2xl mx-auto text-gray-500 text-base sm:text-lg">
            Specialized SEO aligned with your business needs — not generic
            tactics.
          </p>
        </div>
      ...
      <section className="py-16 md:py-20 bg-[#0a0a0a] text-white px-4 sm:px-8 md:px-12 lg:px-20 overflow-hidden">
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <p className="reveal-up text-neutral-400 mb-10 md:mb-12 text-sm sm:text-base md:text-lg">
            Is your brand visible for the terms that matter most?
          </p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 stagger-child">
            {[
              { val: 95, suffix: "%", label: "First Page Rank" },
              { val: 78, suffix: "%", label: "Traffic Increase" },
              { val: 62, suffix: "%", label: "Conversion Lift" },
              { val: 100, suffix: "%", label: "White Hat SEO" },
            ].map((stat, i) => (
      ...
      <section className="py-16 md:py-20 bg-white px-4 sm:px-8 md:px-12 lg:px-20 overflow-hidden">
        <div className="max-w-[1400px] mx-auto">
          ...
          <p className="reveal-up text max-w-6xl mx-auto text-gray-500 text-center mb-10 text-base sm:text-lg">
            Our SEO services are designed to help businesses rank higher,
            attract qualified traffic, and generate consistent leads. As a
            trusted{" "}
            <a className="text-[#2C9F00]" href="/about-us">
              digital marketing agency in USA
            </a>
            , Pure Design Hub delivers strategies that go beyond rankings and
          ...
          <p className="text-center mt-10 md:mt-12 text-gray-600 max-w-3xl mx-auto reveal-up text-sm sm:text-base">
            We combine strategy, content, and optimization into one clear
            process for a stronger digital presence.
          </p>
        </div>
      </section>
      ...
      <section className="relative py-16 md:py-20 bg-[#0a0a0a] px-4 sm:px-8 md:px-12 lg:px-20 overflow-hidden text-neutral-200">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          ...
          <p className="reveal-up text text-neutral-400 text-center mb-10 md:mb-16 max-w-2xl mx-auto text-base sm:text-lg">
            Our proven 4-step SEO framework delivers consistent, measurable
            results.
          </p>
      ...
      <section className="py-16 md:py-20 bg-white text-[#1a1a1a] px-4 sm:px-8 md:px-12 lg:px-20 overflow-hidden relative">
        <div className="max-w-[1200px] mx-auto text-center relative z-10">
          ...
          <p className="reveal-up text-gray-600 max-w-4xl mx-auto mb-10 md:mb-12 text-base sm:text-lg leading-relaxed">
            The goal of SEO should be qualified traffic that supports real
            outcomes.
            <br className="hidden sm:block" />
            When your site is optimized correctly, users find you, trust you,
            and contact you.
          </p>
          <div className="reveal-scale bg-[#f8fafc] p-6 sm:p-10 md:p-12 rounded-3xl md:rounded-[50px] border border-gray-200 max-w-4xl mx-auto">
            <h4 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-[#1a1a1a] uppercase tracking-wider">
              Let Pure Design Hub Help You Rank Higher
            </h4>
            <p className="text-gray-700 mb-6 md:mb-8 text-sm sm:text-base md:text-lg">
              ...
              , we are ready to improve your search presence with a strategy
