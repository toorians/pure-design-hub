...
import AppDevelopmentPricingSection from "@/app/component/app-development-pricing";
      ...
      >
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center xl:gap-10 lg:gap-5 gap-4">
          ...
          <div className="title3 mb-3">
            <h3>Unleashing the Power of Your Mobile App</h3>
            <p className="text mb-4">
              We believe a mobile app should do more than function—it should engage users, tell your brand story, and drive action. At PureDesignHub, our mission is to craft mobile experiences that are intuitive, innovative, and impactful, helping businesses thrive in today’s fast-paced digital world.
            </p>
            <p className="text lg:mb-10 mb-5">
              Our team is passionate about combining cutting-edge technology with smart strategy. Every app we develop is centered on your brand identity, target audience, and business goals. From sleek utility apps to high-performing e-commerce solutions, we ensure every mobile app is responsive, user-friendly, and optimized for success.
            </p>
            <Link
              href="/get-quote"
