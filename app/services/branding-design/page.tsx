...
import BrandingHero from "@/public/assets/images/branding_body.png";
...
import BrandingPricingSection from "@/app/component/branding-pricing";
    ...
    <>
      ...
      <section className="globalBanner_sec relative overflow-hidden h-full w-full xl:mb-40 lg:mb-20 mb-10 bg-linear-to-b from-[#E5EFFF] from-40% to-[#FB591E] to-100% ">
        ...
        <GlobalBanner
          title={
            <>
              Branding and <span>Identity</span>
            </>
          }
          text=""
          imagePath="/assets/images/branding_banner.png"
        />
      </section>
      ...
      >
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center xl:gap-10 lg:gap-5 gap-4">
          ...
          <div className="relative w-full xl:h-[500px] md:h-[400px] sm:h-[300px] h-[200px] rounded-[20px] overflow-hidden">
            <Image
              src={BrandingHero}
              alt="Unleashing Your Brand"
              title="Unleashing Your Brand"
              width={0}
              height={0}
              fill
              sizes="100vw"
          ...
          <div className="title3 mb-3">
            <h3>Unleashing the Power of Your Brand Identity</h3>
            <p className="text mb-4">
              We believe branding should do more than just look good—it should tell your story, captivate your audience, and inspire loyalty. At PureDesignHub, our mission is to create strategic, modern, and impactful brand designs that help businesses stand out in today’s competitive market.
            </p>
            <p className="text lg:mb-10 mb-5">
              Our team is passionate about combining creative vision with smart strategy. Every branding project we undertake is centered on your brand values, target audience, and business objectives. From memorable logos to comprehensive brand identities, we ensure every design is distinctive, cohesive, and optimized to leave a lasting impression.
            </p>
            <Link
              href="/get-quote"
