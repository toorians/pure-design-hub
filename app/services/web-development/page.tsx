...
import WebHero from "@/public/assets/images/service1.png";
...
import WebDevelopmentPricingSection from "@/app/component/web-development-pricing";
...
const images: ImageItem[] = [
  ...
  { src: "/assets/images/portfolio_img5.png", category: ["Web Design"] },
  { src: "/assets/images/portfolio_img6.png", category: ["Web Design"] },
  {
    src: "/assets/images/portfolio_img7.png",
    category: ["Web Design"],
  },
  { src: "/assets/images/portfolio_img8.png", category: ["Web Design"] },
  {
    ...
    <>
      ...
      <section className="globalBanner_sec relative overflow-hidden h-full w-full xl:mb-40 lg:mb-20 mb-10 bg-linear-to-b from-[#E5EFFF] from-40% to-[#FB591E] to-100% ">
        ...
        <GlobalBanner
          ...
          text=""
          imagePath="/assets/images/web_banner.png"
        />
      </section>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center xl:gap-10 lg:gap-5 gap-4">
          ...
          <div className="title3 mb-3">
            ...
            <p className="text mb-4">
              We believe a website should do more than just exist online—it should showcase your brand, engage visitors, and drive results. At PureDesignHub, our mission is to craft digital experiences that are modern, intuitive, and impactful, helping businesses thrive in today’s fast-paced online world.
            </p>
            <p className="text lg:mb-10 mb-5">
              Our team combines creative design with strategic thinking. Every website we develop is built around your brand identity, target audience, and business goals. From sleek portfolios to high-performing e-commerce platforms, we ensure each website is responsive, user-friendly, and optimized for success, delivering an online presence that truly stands out.
            </p>
            <Link
              href="/get-quote"
