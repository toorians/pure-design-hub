...
import NewContactPage from "../component/payment";
  ...
  const services = [
    {
      ...
      text: "Build fast, responsive, and user-friendly websites that drive engagement.",
    ...
    },
    {
      ...
      text: "Create intuitive mobile apps that enhance user experience and growth.",
    ...
    },
    {
      ...
      text: "Craft a strong brand identity that resonates and stands out in the market.",
